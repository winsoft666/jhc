...
#ifndef AKALI_WIN_DIRECTORY_MONITOR_HPP__
#define AKALI_WIN_DIRECTORY_MONITOR_HPP__
...
class WinDirectoryMonitor {
   ...
   private:
    ...
    AKALI_DISALLOW_COPY_AND_ASSIGN(WinDirectoryMonitor);
};
}  // namespace akl
#endif
#endif  // !AKALI_WIN_DIRECTORY_MONITOR_HPP__