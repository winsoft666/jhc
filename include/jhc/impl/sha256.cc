...
void jhc::SHA256::update(const unsigned char* buffer, uint32_t length) {
    uint32_t left;
...
void jhc::SHA256::digest(unsigned char* s) {
    uint32_t i;
...
std::string jhc::SHA256::GetFileSHA256(const jhc::fs::path& filePath) {
    std::string result;
...
std::string jhc::SHA256::GetDataSHA256(const unsigned char* data, size_t dataSize) {
    SHA256 sha256;
    sha256.init();
...
void jhc::SHA256::sha256_block(const unsigned char* block) {
    uint32_t data[SHA256_DATA_LENGTH];
    uint16_t i;
...
void jhc::SHA256::sha256_transform(uint32_t* state, uint32_t* data) {
