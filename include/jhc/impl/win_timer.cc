...
void CALLBACK WinTimerBase::TimerProc(void* param, BOOLEAN timerCalled) {
...
//
bool WinTimerBase::start(unsigned int ulInterval,  // ulInterval in ms
                         bool bImmediately,
                         bool bOnce,
...
void WinTimerBase::stop(bool bWait) {
    if (p_->m_hTimer) {
