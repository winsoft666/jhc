...
#ifdef __has_include
# if __has_include(<jhc/optional.tweak.hpp>)
#  include <jhc/optional.tweak.hpp>
# endif
...
#define nonstd_lite_in_place_t(      T)  jhc::in_place_t(&)( jhc::detail::in_place_type_tag<T>  )
#define nonstd_lite_in_place_type_t( T)  jhc::in_place_t(&)( jhc::detail::in_place_type_tag<T>  )
#define nonstd_lite_in_place_index_t(K)  jhc::in_place_t(&)( jhc::detail::in_place_index_tag<K> )

#define nonstd_lite_in_place(      T)    jhc::in_place_type<T>
#define nonstd_lite_in_place_type( T)    jhc::in_place_type<T>
#define nonstd_lite_in_place_index(K)    jhc::in_place_index<K>
...
namespace jhc { namespace optional_lite {
...
template< class T >
struct hash< jhc::optional<T> >
{
public:
    std::size_t operator()( jhc::optional<T> const & v ) const optional_noexcept
    {
