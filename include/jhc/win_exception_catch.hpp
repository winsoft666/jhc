...
#define WINMAIN_BEGIN(szDumpNamePrefix)                                                                 \
    ...
    LONG WINAPI __96A9695E_UnhandledExceptionHandler(_EXCEPTION_POINTERS* pExceptionInfo) {             \
        ...
        int iRet = jhc::WinExceptionCatchInternal::RecordExceptionInfo(pExceptionInfo, szDumpNamePrefix);                        \
        return iRet;                                                                                    \
    }                                                                                                   \
    int APIENTRY _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine,              \
        ...
        } __except (jhc::WinExceptionCatchInternal::RecordExceptionInfo(GetExceptionInformation(), szDumpNamePrefix)) {          \
...
#define WMAIN_BEGIN(szDumpName)                                                                     \
    ...
    LONG WINAPI __96A9695E_UnhandledExceptionHandler(_EXCEPTION_POINTERS* pExceptionInfo) {         \
        ...
        int iRet = jhc::WinExceptionCatchInternal::RecordExceptionInfo(pExceptionInfo, szDumpName);                          \
        return iRet;                                                                                \
    }                                                                                               \
    int wmain(int argc, wchar_t* argv[]) {                                                          \
        ...
        } __except (jhc::WinExceptionCatchInternal::RecordExceptionInfo(GetExceptionInformation(), szDumpName)) {            \
            OutputDebugString(                                                                      \
