...
#ifndef JHC_XOR_STR_HPP__
#define JHC_XOR_STR_HPP__
//
...
#define XORSTRA(s) (jhc::XorStr<char, _countof(s), __COUNTER__>(s, std::make_index_sequence<_countof(s) - 1>()).decrypt())
#define XORSTRW(s) (jhc::XorStr<wchar_t, _countof(s), __COUNTER__>(s, std::make_index_sequence<_countof(s) - 1>()).decrypt())
